...
import PolyglotBadges   from './polyglot/badges.mdx'
import ProviderBadges   from './puppet-providers/badges.mdx'
import ServiceBadges    from './puppet-services/badges.mdx'
