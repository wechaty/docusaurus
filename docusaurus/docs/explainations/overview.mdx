...
## [Software Development Kit(SDK)](#placeholder)

Wechaty is a modern conversational robotic process automation SDK for chatbot makers. In this section, you will gain an understanding of what a Software Development Kit is and why Wechaty should be your preferred SDK for making chatbots.
