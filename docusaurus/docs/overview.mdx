...
The advanced tutorials require you to have atleast intermediate to advanced knowledge of Wechaty and chatbot development. If you are an experienced Wechaty developer, you can go ahead and explore the other sections of the documentation like [How to Guides](howto/overview.mdx), [Reference Guides](references/overview.mdx) and the [Explanation section](#placeholder) as well to gain more insights about Wechaty.
