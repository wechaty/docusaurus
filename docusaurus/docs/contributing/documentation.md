...
- General improvements: typo corrections, error fixes, and better
  explainations through clearer writing and more examples.
...
- [How-to Guides](howto/overview.mdx) are recipes that take the reader through
  ...
  These guides are more advanced than tutorials and assume some knowledge about how Wechaty works. Assume that the reader has followed the tutorials and don't
