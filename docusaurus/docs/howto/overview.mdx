...
How-to guides are recipes and they guide you through the steps involved in addressing key problems and use-cases.
...
- [Start wechaty](howto/starter.md)
...
- [Sending and Receiving files](howto/file-box.md)
...
- [Deploy in WeChat](howto/deploy-in-wechat.md)
- [Deploy in Whatsapp](howto/deploy-in-whatsapp.md)

## Deploy with containers

Deploy the bot with highly popular container solutions

- [Deploy with Heroku](tutorials/usage-with-heroku.md)
- [Deploy with Docker](tutorials/docker.md)

## FAQ

- [Get answer when you have a problem](howto/faq.md)
