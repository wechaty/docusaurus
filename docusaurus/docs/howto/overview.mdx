...
- [Add events and customise a bot](howto/event.mdx)
...
- [Manage contacts](howto/contact.mdx)
- [Manage rooms](howto/room.md)
- [Send and accept friend requests](howto/friendship.mdx)
- [Send and receive files](howto/file-box.mdx)
...
- [Deploy in WeChat](howto/deploy-wechat.mdx)
    - [Deploy in PadLocal puppet](howto/deploy-padlocal.mdx)
    - [Deploy in WeChat4U puppet](howto/deploy-wechat4u.mdx)
- [Deploy in Whatsapp](howto/deploy-whatsapp.mdx)
- [Deploy in Lark](howto/deploy-lark.mdx)
- [Deploy in Gitter](howto/deploy-gitter.mdx)
- [Deploy in Official Account](howto/wechat-official.mdx)

## Deploy with containers

Deploy the bot with highly popular container solutions

- [Deploy with Heroku](howto/heroku.mdx)
