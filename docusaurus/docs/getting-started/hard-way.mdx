...
1. Getting Started
2. Clone the [Ding Dong Bot](https://github.com/shwetalsoni/ding-dong-bot) repository
...
Just scan the generated QR code with Wechat/WhatsApp app and you are ready to go.
...
You can clone the [Ding Dong Bot](https://github.com/shwetalsoni/ding-dong-bot) repository by following the below command, and navigate to the directory:

```bash
git clone https://github.com/shwetalsoni/ding-dong-bot
cd ding-dong-bot
```
...
* [wechaty-plugin-contrib](https://www.npmjs.com/package/wechaty-plugin-contrib): JavaScript function that returns a function which accepts a Wechaty instance
