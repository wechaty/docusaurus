...
1. After you logged in to the WeChat or Whatsapp, you code will be able to process the received messages, as well as reply them as you wish.
...
![image](https://wechaty.js.org/assets/2021/04-gitpod-getting-started/gitpod.png)

Gitpod in an online IDE which provides you with a complete development envioronment accompanied by a VS-Code powered IDE and a cloud-based Linux container.
