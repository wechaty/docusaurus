...
![Scan Whatsapp QR Code from terminal page](../../static/img/docs/cloud-scan-QR-whatsapp.png)
...
![Getting Started Tutorial Completion Page](../../static/img/docs/getting-started-tutorial-completion.png)
