...
![image](https://wechaty.js.org/docusaurus/static/img/docs/getting-started/gitpod.png)
...
![image](https://wechaty.js.org/docusaurus/static/img/docs/getting-started/gitpod_2.png)
