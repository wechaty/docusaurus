...
![image](../../static/img/docs/getting-started/cloud_1.png)

Click Continue. You will see this page :

![image](../../static/img/docs/getting-started/cloud_2.png)

It will the take you to the cloud shell editor :

![image](../../static/img/docs/getting-started/cloud_3.png)

The Wechaty tutorial will open up!

![image](../../static/img/docs/getting-started/cloud_4.png)

Follow the instructions :

![image](../../static/img/docs/getting-started/cloud_5.png)
