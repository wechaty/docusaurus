...
import FridayQrCode from '../src/components/friday-qrcode'
...
Learn more functions from [API Reference](./references/overview.mdx) and [How-to Guides](./howto/overview.mdx).
