---
layout: post
title: 用'用Chatie实现微信机器人商业逻辑之【好室友】群管理篇实现微信机器人商业逻辑之【好室友】群管理篇'
author: xinbenlv
date: '2017-04-16 14:42:53 +0800'
published: true
---
#<img 用Chatie实现微信机器人商业逻辑之【好室友】群管理篇

作者: [@xinbenlv](src="https://githubavatars2.githubusercontent.com/u/7746790?v=3&s=88">
...
每个微信群常年满上限500人。我们要求入群的朋友修改群昵称，我们每周要按照一定的规则将人。我们要求入群的朋友修改群昵称，我们每周要按照一定的规则
不按照要求修改群昵称的群友和最早入群的人踢出，以实现群员的流动，讲不按照要求修改群昵称的群友和最早入群的人，以实现群的流动。另外，我们不允许发布与租房
确保群里都是最近有租房需求的朋友而不是许多租房群常见的僵尸群情况。无关的信息，因为群规模和口碑都还不错，经常有人进入我们的微信群发布广告消息和无关消息，

另外，我们不允许发布任何与租房无关的信息：广告、二手交易、机票信息等常见扩散信息都被视为禁止类型。我们对于这种情况会予以警告直至踢出群。
...
简化了管理员的工作量，也提高和改善了用户在群里的体验。简化了管理员的工作量，也提高和改善了用户在群里的体现。
