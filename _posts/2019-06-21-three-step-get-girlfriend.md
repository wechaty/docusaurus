...
![](/assets/2019/everyday-header.png)
...
![](/assets/2019/everyday-1.png)

![](/assets/2019/everyday-2.png)
...
![](/assets/2019/everyday-5.png)


* 进到目录中，找到`config`目录下的`index.js`文件

![](/assets/2019/everyday-6.png)

![](/assets/2019/everyday-7.png)
...
![](/assets/2019/everyday-11.png)

* 然后输入`npm install`。

![](/assets/2019/everyday-12.png)

* 等待安装完成后输入`npm run start`，这时会下载一个文件，因为比较大，所以要多等一下，等待出现二维码的时候就可以拿出手机微信扫一扫登录了。接下来就是一顿神对话了😆



![](/assets/2019/everyday-13.png)


![](/assets/2019/everyday-14.png)
