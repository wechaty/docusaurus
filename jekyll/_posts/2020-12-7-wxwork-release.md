...
const token = 'get a wxwork token from: https://github.com/wechaty/puppet-service-providers#buy-token'
...
- [x] 产品测试：
  - [x] 通过[句子秒回](https://crm.botorange.com/)的在线测试，详见[Product Test](https://github.com/wechaty/puppet-service-providers/wiki/Product-Test)
